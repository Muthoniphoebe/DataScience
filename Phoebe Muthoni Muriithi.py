...
#adjust file_type to the type the data file is stored as.
#this could be csv, xlsx,json etc

df = pd.read_file_type('file_name.file_type')
...
This code displays the average petal length for each class of iris flowers:
